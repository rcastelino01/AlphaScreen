...
```
Create folders named **inputs** and **weights** within the cloned folder. Then place your .fasta file and your AlphaFold3 weights (your af3.bin.zst) file, in each of the respective folders.
